...
const DEFAULT_HERO = {
  ...
  testimonialText:
    'Perfect for testing - clean, simple, and functional. Everything works exactly as expected.',
  testimonialAuthor: 'Test User',
  testimonialRole: 'Quality Assurance',
  testimonialRating: 5,
  ...
  statsLabel2: 'Uptime',
  statsValue3: '1ms',
  statsLabel3: 'Response Time',
  announcementText: 'Test mode: All systems operational',
