...
const DEFAULT_FOOTER = {
  logoText: 'TestSite',
  companyDescription:
    'A simple test website showcasing modern web development with clean, minimal design. Built for testing and demonstration purposes.',
  contactEmail: 'test@testsite.com',
  contactPhone: '+1 (555) 000-0000',
  contactAddress: '123 Test Street, Demo City',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer: 'Get updates about our test site. No spam, unsubscribe anytime.',
  ...
  linkCookieSettingsHref: '#cookie-settings',
  linkSupport: 'Support',
